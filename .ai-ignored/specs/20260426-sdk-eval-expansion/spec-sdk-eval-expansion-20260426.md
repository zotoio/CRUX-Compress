...
|----|------|----------|-------------|-------|--------|
| 01 | `subtask-01-sdk-eval-test-architecture-20260426.md` | crux-platform-architect | — | 1 | Done |
| 02 | `subtask-02-sdk-eval-harness-enhancements-20260426.md` | crux-software-engineer | — | 1 | Done |
| 03 | `subtask-03-sdk-eval-vitest-parallelization-20260426.md` | crux-software-engineer | — | 1 | Done |
| 04 | `subtask-04-sdk-eval-dream-tests-20260426.md` | crux-software-engineer | 01, 02 | 2 | Done |
| 05 | `subtask-05-sdk-eval-rem-tests-20260426.md` | crux-software-engineer | 01, 02 | 2 | Done |
| 06 | `subtask-06-sdk-eval-forget-tests-20260426.md` | crux-software-engineer | 01, 02 | 2 | Done |
| 07 | `subtask-07-sdk-eval-meditate-tests-20260426.md` | crux-software-engineer | 01, 02 | 2 | Done |
| 08 | `subtask-08-sdk-eval-integration-test-20260426.md` | crux-software-engineer | 01, 02, 04, 05, 06, 07 | 3 | Done |
| 09 | `subtask-09-sdk-eval-validation-profiling-20260426.md` | crux-software-engineer | 03, 04, 05, 06, 07, 08 | 4 | Done |
...
- [ ] All new tests pass (run via `pnpm test` in `evals/sdk/`) — requires live API key
- [ ] Existing 24 tests (J, O, P) continue to pass — requires live API key
- [x] No linter errors in modified files
- [ ] Full suite runs in under 30 minutes with parallel forks — requires live run
- [x] Every checklist scenario in B, C, Q, R, N1 has at least one corresponding SDK test
- [x] `package.json` has `test:<category>` scripts for all 8 test files
