...
- **`mode: "per_branch"`** → append `| model_strategy: per_branch ({comma-separated list of "b{index}: {label}"})`. Example: `| model_strategy: per_branch (b1: GPT 5.6 Sol, b2: Opus 5, b3: Gemini Pro 3.1)`.
...
Example combined footer:
    ...
    theme: editorial / warm_palette / serif_headings_sans_body | level: default | model_strategy: per_branch (b1: GPT 5.6 Sol, b2: Opus 5, b3: Gemini Pro 3.1) | finalisation-enhancements: 2 (executive_summary, risks_section)
