...
- Read `CRUX.md` only if you encounter `.memory.crux.md` files or other CRUX-notated content that needs decompression.
- Read `.crux/crux-memories.json` to load the meditation configuration. Extract and
respect:
